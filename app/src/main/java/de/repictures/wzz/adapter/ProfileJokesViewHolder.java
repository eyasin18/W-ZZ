...
public class ProfileJokesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {

    public TextView inhalt, voteCounter, voteCounterAnimator;
    public ImageView profilePic, thumbUp, favorite;
    private ClickListener clickListener;

    public ProfileJokesViewHolder(View v) {
        super(v);
