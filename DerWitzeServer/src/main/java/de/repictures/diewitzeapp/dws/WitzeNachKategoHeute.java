...
public class WitzeNachKategoHeute {
    public WitzeNachKategoHeute(int count, DatastoreService datastore, Key postKey,
                                String profileKey, HttpServletResponse resp) throws EntityNotFoundException, IOException {
    ...
    private Boolean getTimePosted(Entity e) {
        ...
        c1.add(Calendar.DAY_OF_YEAR, -4); // 3 Tage vorher
        Date h = c1.getTime();
